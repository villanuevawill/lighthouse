use shard_store::iter::{BlockRootsIterator, StateRootsIterator};
use types::{Hash256, ShardSlot};
...
pub type ReverseHashAndSlotIterator<I> = ReverseChainIterator<(Hash256, ShardSlot), I>;
